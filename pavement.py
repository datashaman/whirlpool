...
setup(
    name='whirlpool',
    version=version,
    description='Tuplespace implementation for python.',
    long_description=open('README.rst', 'r').read(),
    classifiers=classifiers,
    keywords='tuplespace linda',
    author='Marlin Forbes',
    author_email='marlinf@datashaman.com',
    url='http://github.com/datashaman/whirlpool',
    license='BSD',
...
options.setup.package_data=paver.setuputils.find_package_data(
    'whirlpool', package='whirlpool', only_in_packages=False)
